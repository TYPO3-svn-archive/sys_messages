...
$TCA['sys_workflows'] = Array (
	...
	'interface' => Array (
		'showRecordFieldList' => 'title,description,tablename,tablename_ver,tablename_del,tablename_move,working_area,allowed_groups,review_users,final_target,final_unhide,final_set_perms'
	),
	'columns' => Array (	
		'title' => Array (
	...
	'types' => Array (					
										'1' => Array('showitem' => 'hidden;;;;1-1-1,title;;;;2-2-2,description,--div--;table,tablename;;;;3-3-3,tablename_ver,tablename_del,tablename_move,--div--;roles,allowed_groups,target_groups,review_users,publishing_users,--div--;misc,working_area,final_target,,final_unhide,final_set_perms;;;;5-5-5,final_perms_userid,final_perms_groupid,final_perms_user,final_perms_group,final_perms_everybody'),
		'0' => Array('showitem' => 'hidden;;;;1-1-1,title;;;;2-2-2,description,--div--;table,tablename;;;;3-3-3,tablename_ver,tablename_del,tablename_move,--div--;roles,allowed_groups,target_groups,review_users,publishing_users,--div--;misc,working_area,final_target,,final_unhide,final_set_perms;;;;5-5-5')
